...
dotenv.config();
import { loginField, registerField, updateField, verifyOTPField } from "../utils/inputField.js";
import {
	encryptPassword,
	decryptPassword,
	jwtSign,
...
export const sendNotificationEmails = (
	...
	return Promise.all([sendEmail(superAdminNotification), sendEmail(newAdminNotification)]);
};
